...
import { vaultDiffCompute } from "@/modules/documents/vaultDiffCompute";
import type { VaultVersion } from "@/modules/documents/vaultsTypes";

type VaultHistoryPanelProps = {
 ...
 */
export const VaultHistoryPanel = React.memo<VaultHistoryPanelProps>(({ versions, loading }) => {
...
const DiffView = React.memo<DiffViewProps>(({ oldBody, newBody, oldTitle, newTitle }) => {
    ...
    const bodyDiff = React.useMemo(() => vaultDiffCompute(oldBody, newBody), [oldBody, newBody]);
