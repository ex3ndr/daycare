...
import { vaultSlugGenerate } from "@/modules/documents/vaultSlugGenerate";
 ...
 */
export const VaultCreateDialog = React.memo<VaultCreateDialogProps>((props) => {
    ...
    const handleTitleChange = React.useCallback(
        (text: string) => {
            setTitle(text);
            if (!slugManual) {
                setSlug(vaultSlugGenerate(text));
            }
        },
        [slugManual]
    );
    ...
    const handleCreate = React.useCallback(() => {
        ...
        const trimmedSlug = slug.trim() || vaultSlugGenerate(trimmedTitle);
