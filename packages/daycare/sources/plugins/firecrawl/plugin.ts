...
const fetchSchema = Type.Object(
    {
        ...
        formats: Type.Optional(
            Type.Array(Type.Union([Type.Literal("markdown"), Type.Literal("html"), Type.Literal("rawHtml")]), {
                description: "Output formats: markdown, html, or rawHtml"
            })
        ),
        onlyMainContent: Type.Optional(Type.Boolean({ description: "Whether to extract only the main content" })),
        ...
        return {
            load: async () => {
                api.registrar.registerTool({
                    tool: {
                        name: toolName,
                        description: "Fetch web page content using Firecrawl. Returns clean markdown or HTML content.",
