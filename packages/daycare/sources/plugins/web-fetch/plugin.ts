...
const fetchSchema = Type.Object(
    {
        ...
        timeoutMs: Type.Optional(Type.Number({ minimum: 1000, maximum: 30000, description: "Request timeout in ms" }))
    },
        ...
        return {
            load: async () => {
                api.registrar.registerTool({
                    tool: {
                        name: toolName,
                        description: "Fetch web page content with a plain HTTP request (no JavaScript rendering).",
