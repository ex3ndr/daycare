...
export type UpgradePm2ProcessDetectResult =
  | { found: true; processName: string }
 ...
 */
export async function upgradePm2ProcessDetect(
  processName: string
): Promise<UpgradePm2ProcessDetectResult> {
  let output: string;
  try {
