...
const fetchSchema = Type.Object(
    {
        ...
        instruction: Type.Optional(Type.String({ description: "Optional instruction for how to process the content" }))
    },
...
async function resolveAnthropicApiKey(auth: AuthStore, instanceId: string): Promise<string | null> {
