 ...
 */
export function exposeUpdateToolBuild(exposes: Pick<Exposes, "update">): ToolDefinition {
    return {
        tool: {
            name: "expose_update",
            description: "Update expose endpoint authentication; enabling auth returns a new password.",
            parameters: schema
        },
