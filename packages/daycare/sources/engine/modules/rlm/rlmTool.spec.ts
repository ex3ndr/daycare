...
describe("rlmToolBuild", () => {
    ...
    it("executes python and formats output", async () => {
        ...
        const result = await tool.execute({ code: "print('debug')\nvalue = echo('hello')\nvalue" }, createContext(), {
            id: "tool-call-1",
            name: "run_python"
        });
    ...
    it("returns syntax errors with recovery guidance", async () => {
        ...
        const result = await tool.execute({ code: "def broken(:\n  pass" }, createContext(), {
            id: "tool-call-2",
            name: "run_python"
        });
    ...
    it("returns runtime traceback for unhandled runtime errors", async () => {
        ...
        const result = await tool.execute({ code: "1 / 0" }, createContext(), {
            id: "tool-call-3",
            name: "run_python"
        });
    ...
    it("returns type-check diagnostics for invalid tool argument types", async () => {
        ...
        const result = await tool.execute({ code: "echo(1)" }, createContext(), {
            id: "tool-call-typing",
            name: "run_python"
        });
    ...
    it("writes checkpoint history through appendHistoryRecord when provided", async () => {
        ...
        const result = await tool.execute({ code: "echo('runtime')" }, createContext({ appendHistoryRecord }), {
