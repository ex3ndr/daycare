 ...
 */
export async function peopleVaultFrontmatterAssert(options: PeopleDocumentFrontmatterAssertOptions): Promise<void> {
...
async function peopleDocumentInTreeIs(
    ...
    const chain = await vaultChainResolve(ctx, parentId, documents);
