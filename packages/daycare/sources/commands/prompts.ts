...
export async function promptConfirm(config: PromptConfirmConfig): Promise<boolean | null> {
...
export async function promptSelect<TValue extends string>(config: PromptSelectConfig<TValue>): Promise<TValue | null> {
