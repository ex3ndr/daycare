...
- `daycare-app-public-endpoint-links.md` - split app/backend endpoint behavior for generated app-link URLs
- `daycare-app-root-welcome.md` - root route behavior for daycare-app-server welcome response
