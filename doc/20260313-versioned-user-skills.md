...
- Replaced versions move into `users/<userId>/skills-history/<skill-name>/versions/<n>/`.
- The current version number is tracked in `users/<userId>/skills-history/<skill-name>/current.json`.
...
flowchart TD
    ...
    D -->|yes| F[Copy current folder to skills-history/<name>/versions/<current>]
...
flowchart LR
    ...
    B --> C[Read skills-history/<name>/current.json]
    ...
    G -->|yes| I[Copy skills-history/<name>/versions/<n>]
